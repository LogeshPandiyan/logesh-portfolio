export const PORTFOLIO_DATA = {
  personalInfo: {
    ...
    bio: "Hi, I'm Logesh P — a Computer Science Graduate and Associate MERN Stack Developer with hands-on experience building scalable, secure, and production-oriented full-stack web applications. Skilled in React.js, JavaScript, Node.js, Express.js, and MongoDB, with practical experience developing RESTful APIs, responsive user interfaces, authentication, authorization systems, and Role-Based Access Control (RBAC). Experienced in designing and developing real-world applications such as Digital Document Management Systems (DSMS) and Project Management Systems (PMS).",
  ...
  skills: {
    frontend: [
      ...
      { name: "Bootstrap 5 & Tailwind CSS", level: 85, category: "Frontend" },
      { name: "JavaScript (ES6+)", level: 92, category: "Frontend" },
      { name: "React.js", level: 90, category: "Frontend" },
      { name: "Axios & RTK Query (Redux)", level: 88, category: "Frontend" },
    ],
    backend: [
      { name: "Node.js & Express.js", level: 88, category: "Backend" },
      { name: "RESTful APIs", level: 90, category: "Backend" },
      { name: "JWT Auth & RBAC Architecture", level: 88, category: "Backend" },
    ],
    database: [
    ...
    tools: [
      ...
      { name: "Vercel, Render and MongoDB Atlas", level: 90, category: "Tools" },
      { name: "Agile / CI/CD", level: 75, category: "Tools" },
    ],
    softSkills: [
      "Problem Solving",
      "Decision Making",
