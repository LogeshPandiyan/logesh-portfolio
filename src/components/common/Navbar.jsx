...
import { Menu, X, Code, ArrowUpRight } from 'lucide-react';
    ...
    >
      <div className="max-w-[1536px] mx-auto px-6 sm:px-10 lg:px-12">
        <div className="flex items-center justify-between">
          ...
          {/* Desktop Nav Links */}
          <nav className="hidden md:flex items-center gap-1 bg-slate-800/60 p-1.5 rounded-full border border-slate-700/50 backdrop-blur-sm">
            {navLinks.map((link) => {
